...
\begin{assumption}
\label{ass:embehave}
Let $c_m = 1/16$.\swcomment{subscript $m$ meant anything?} \jmcomment{It means a constant for some assumptions about means but nothing else. Just want to make it different from other constants. Maybe there are better notations.}. 
\begin{itemize}
