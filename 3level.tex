...
The intermediate case is more challenging since the gap is neither
small enough to have negligible effect on regret nor large enough to
make the arms distinguishable after the first level. In this case, we
need to ensure that both arms will continued to be pulled in the
second level. To achieve this, we will take advantage of the clean
events of $W_1$ and $W_4$.
