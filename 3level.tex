...
\begin{align*}
\hat{\mu}_a^t - \hat{\mu}_a^t &>\bar{\mu}_a^{1,s_a} - \bar{\mu}_a^{1,s_a} - \frac{c_m}{\sqrt{q_1T_1/2}} - \frac{c_m}{\sqrt{q_2T_1/2}}\\
