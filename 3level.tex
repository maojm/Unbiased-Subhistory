...
\subsection{Events}
We will first establish four \nidelete{\emph{clean events}} \niedit{events} \nicomment{this is a dumb name, what's clean or dirty about an event?  i advocate deleting this adjective from our paper, as i did for the 2level section} that together occur
...
deviations are in the order of $\Omega(\sqrt{1/T_1})$, the sub-history
from this ``lucky'' group will induce a pair of estimates such that
