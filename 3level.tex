...
\begin{lemma}[High and low deviations for the arms]\label{3levelw4}
...
arms. We break down the regret analysis into 4 cases on the scale of
the gap parameter $\Delta = (\mu_1-\mu_2)$.
...
The analysis becomes more challenging when the gap is neither too
...
\begin{proof}
\OMIT{Wlog we assume $\mu_1 \geq \mu_2$ as the recommendation policy is symmetric to both arms. We do a case analysis based on $\mu_1-\mu_2$. 
