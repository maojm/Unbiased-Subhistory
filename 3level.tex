...
Now we demonstrate how to design a policy to incentivize adaptive
exploration and improve on the $O(T^{2/3})$ regret rate. For
simplicity, we assume there are only 2 arms.
