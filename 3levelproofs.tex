...
\begin{align*}
\hat{\mu}_1^t - \hat{\mu}_2^t &>\bar{\mu}_1^{1,s} - \bar{\mu}_2^{1,s} - \frac{C_0}{\sqrt{\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{\fdpN[2]T_1/2}}\\
&\geq  \sqrt{\frac{4\log(T)}{\fdpN[1]T_1}} + \sqrt{\frac{4\log(T)}{\fdpN[2]T_1}}- \frac{C_0}{\sqrt{\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{\fdpN[2]T_1/2}} > 0
\end{align*}
...
\begin{align*}
\hat{\mu}_1^t - \hat{\mu}_2^t &>\bar{\mu}_1 - \bar{\mu}_2 - \frac{C_0}{\sqrt{S\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{S\fdpN[2]T_1/2}}\\
&\geq  \sqrt{\frac{4\log(T)}{S\fdpN[1]T_1}} + \sqrt{\frac{4\log(T)}{S\fdpN[2]T_1}}- \frac{C_0}{\sqrt{S\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{S\fdpN[2]T_1/2}}\\
 &> 0.
\end{align*}
So we know agents in the third-level group will all pull arm 1. \OMIT{Therefore the expected regret is at most
\[
(S \GdT T_1 + S T_2) \cdot 2\left(\sqrt{\frac{4\log(T)}{\fdpN[1]T_1}}
...
\begin{align*}
\hat{\mu}_a^t - \hat{\mu}_{3-a}^t &>\bar{\mu}_a^{1,s_a} - \bar{\mu}_{3-a}^{1,s_a} - \frac{C_0}{\sqrt{\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{\fdpN[2]T_1/2}}\\
&\geq   \frac{1}{8\sqrt{\fdpN[1]T_1}}+ \frac{1}{8\sqrt{\fdpN[2]T_1}}- \frac{C_0}{\sqrt{\fdpN[1]T_1/2}} - \frac{C_0}{\sqrt{\fdpN[2]T_1/2}}\\
 &> 0.
\end{align*}
...
\[
(S \GdT T_1 + S T_2) \cdot 2\left(\sqrt{\frac{4\log(T)}{S\fdpN[1]T_1}}
