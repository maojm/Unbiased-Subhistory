...
\newcommand{\ALGG}{\term{FullDisclosure}}
...
\newcommand{\fdpN}[1][a]{N^\fdp_{K,#1}} % Exp #pulls for arm $a$ in greedy path of length L_K.

% Greedy notation
\def\GdT{L_K} % sufficient length of greedy path
\def\GdP{p_K} % success prob for greedy path
