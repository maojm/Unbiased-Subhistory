...
In addition, we know that this case happens with probability at least $(1/3)^{\GdT} = \GdP$ as each arm's mean is at most $2/3$.\swcomment{where did we assume that?} To sum up, we know that with probability at least $\GdP$, \ALGG of $\GdT$ rounds pulls arm $a$ at least once. 
\end{proof}
%%% Local Variables:
%%% mode: latex
%%% TeX-master: "main"
